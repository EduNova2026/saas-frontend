...
type Styles = {
  ...
  input: (focused: boolean, error: boolean) => CSSProperties;
  eyeToggle: CSSProperties;
  errorBanner: CSSProperties;
  btnLogin: (loading: boolean) => CSSProperties;
  successOverlay: (visible: boolean) => CSSProperties;
  successCheck: CSSProperties;
  successTitle: CSSProperties;
  successSub: CSSProperties;
};
...
const styles: Styles = {
  ...
  successOverlay: (visible: boolean) => ({
    position: "fixed",
    inset: 0,
